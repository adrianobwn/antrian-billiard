...
@section('title', 'Customer Login - Billiard Reservation')
            ...
            <form class="mt-8 space-y-6" action="{{ route('customer.login') }}" method="POST">
                ...
                <div class="text-center space-y-4">
                    <p class="text-sm text-green-medium">
                        ...
                        <a href="{{ route('customer.register') }}" class="font-bold text-green-dark hover:text-green-accent transition-colors duration-300 hover:underline">
                            Create one here
                        </a>
                    </p>
                    <div class="border-t border-green-200 pt-4">
                        <a href="{{ route('admin.login') }}" class="text-sm text-green-medium hover:text-green-dark transition-colors duration-300 hover:underline font-medium">

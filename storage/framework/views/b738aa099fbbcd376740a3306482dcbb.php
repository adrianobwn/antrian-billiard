    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Or
                <a href="<?php echo e(route('customer.register')); ?>" class="font-medium text-blue-600 hover:text-blue-500">
        ...
        <form class="mt-8 space-y-6" action="<?php echo e(route('customer.login')); ?>" method="POST">
            ...
            <div class="text-center">
                <a href="<?php echo e(route('admin.login')); ?>" class="text-sm text-gray-600 hover:text-gray-900">

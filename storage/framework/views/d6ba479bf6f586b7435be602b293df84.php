    ...
    <div x-data="{ mobileMenu: false }">
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <a href="<?php echo e(route('customer.dashboard')); ?>" class="text-xl font-bold text-cream-light hover-lift flex items-center space-x-2">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        <a href="<?php echo e(route('customer.dashboard')); ?>" class="text-cream hover:text-green-accent transition-all duration-300 hover:scale-110 font-medium">
                            Dashboard
                        </a>
                        <a href="<?php echo e(route('customer.reservations.create')); ?>" class="text-cream hover:text-green-accent transition-all duration-300 hover:scale-110 font-medium">
                            Book Table
                        </a>
                        <a href="<?php echo e(route('customer.reservations.my')); ?>" class="text-cream hover:text-green-accent transition-all duration-300 hover:scale-110 font-medium">
                            My Reservations
                        </a>
                ...
                <div x-show="mobileMenu" x-transition:enter="transition ease-out duration-200" class="md:hidden">
                    <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        <a href="<?php echo e(route('customer.dashboard')); ?>" class="block px-3 py-2 text-cream hover:bg-green-accent hover:text-green-dark rounded-lg transition-all duration-200 font-medium">Dashboard</a>
                        <a href="<?php echo e(route('customer.reservations.create')); ?>" class="block px-3 py-2 text-cream hover:bg-green-accent hover:text-green-dark rounded-lg transition-all duration-200 font-medium">Book Table</a>
                        <a href="<?php echo e(route('customer.reservations.my')); ?>" class="block px-3 py-2 text-cream hover:bg-green-accent hover:text-green-dark rounded-lg transition-all duration-200 font-medium">My Reservations</a>
                        <form action="<?php echo e(route('customer.logout')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
        ...
        <nav class="bg-gradient-green text-cream shadow-2xl border-b-4 border-green-800 relative overflow-hidden">
            ...
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-xl font-bold text-cream-light hover-lift flex items-center space-x-2">
                    ...
                    <!-- Desktop Menu -->
                    <div class="hidden md:flex items-center space-x-8">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="text-cream hover:text-green-accent transition-all duration-300 hover:scale-110 font-medium">
                            Dashboard
                        </a>
                        <a href="<?php echo e(route('admin.reservations.index')); ?>" class="text-cream hover:text-green-accent transition-all duration-300 hover:scale-110 font-medium">
                            Reservations
                        </a>
                        <div class="relative" x-data="{ dropdown: false }">
                            <button @click="dropdown = !dropdown" class="text-cream hover:text-green-accent transition-all duration-300 hover:scale-110 font-medium flex items-center">
                            ...
                            <div x-show="dropdown" @click.away="dropdown = false"
                                ...
                                <a href="<?php echo e(route('admin.table-types.index')); ?>" class="block px-4 py-2 text-sm text-green-dark hover:bg-green-accent hover:text-cream rounded transition-all duration-200">Table Types</a>
                                <a href="<?php echo e(route('admin.tables.index')); ?>" class="block px-4 py-2 text-sm text-green-dark hover:bg-green-accent hover:text-cream rounded transition-all duration-200">Tables</a>
                                <a href="<?php echo e(route('admin.promos.index')); ?>" class="block px-4 py-2 text-sm text-green-dark hover:bg-green-accent hover:text-cream rounded transition-all duration-200">Promos</a>
                            </div>
                        </div>
                        <a href="<?php echo e(route('admin.reports')); ?>" class="text-cream hover:text-green-accent transition-all duration-300 hover:scale-110 font-medium">
                            Reports
                        </a>
                        <div class="relative" x-data="{ dropdown: false }">

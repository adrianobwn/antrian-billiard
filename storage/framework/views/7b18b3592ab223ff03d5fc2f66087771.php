<?php $__env->startSection('title', 'Customer Dashboard - Billiard Reservation'); ?>
...
<div class="max-w-7xl mx-auto">
    ...
    <div class="glass-effect rounded-2xl p-8 mb-8 animate-slide-in shadow-glow border border-green-200">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-green-dark text-shadow">Welcome back, <?php echo e(Auth::guard('web')->user()->name); ?>!</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="glass-effect rounded-2xl p-6 hover-lift shadow-lg border border-green-200 animate-fade-in" style="animation-delay: 0.2s">
            ...
            <div class="mt-6">
                <a href="<?php echo e(route('customer.reservations.my')); ?>"
        ...
        <div class="p-6">
            <?php if($recentReservations->count() > 0): ?>
                            ...
                            <div class="flex-1">
                                <div class="flex items-center">
                                    <h3 class="text-sm font-bold text-green-dark">
                                        🎱 Table <?php echo e($reservation->table->table_number); ?> - <?php echo e($reservation->table->tableType->name); ?>

                                    </h3>
                                    <span class="ml-3 px-3 py-1 text-xs font-bold rounded-full
                                        <?php if($reservation->status === 'confirmed'): ?> bg-green-accent text-green-dark shadow-sm
                                        <?php elseif($reservation->status === 'pending'): ?> bg-yellow-400 text-yellow-900 shadow-sm
                                        <?php elseif($reservation->status === 'completed'): ?> bg-blue-400 text-blue-900 shadow-sm
                                        <?php else: ?> bg-red-400 text-red-900 shadow-sm <?php endif; ?>">
                                        <?php echo e(ucfirst($reservation->status)); ?>

                                    </span>
                                </div>
                                <p class="mt-2 text-sm text-green-medium font-medium">
                                    <?php echo e($reservation->reservation_time->format('M j, Y \a\t g:i A')); ?> • <?php echo e($reservation->duration_hours); ?> hour(s)
                                </p>
                ...
                <div class="mt-8 text-center">
                    <a href="<?php echo e(route('customer.reservations.my')); ?>" class="inline-flex items-center text-green-dark font-bold hover:text-green-light transition-colors duration-300">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/adrianobawan/Study/Iyan/Projek/antrian-billiard/resources/views/customer/dashboard.blade.php ENDPATH**/ ?>
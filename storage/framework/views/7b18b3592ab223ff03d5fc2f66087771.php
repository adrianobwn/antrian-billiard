...
<div class="max-w-7xl mx-auto">
    ...
    <div class="bg-white shadow rounded-lg p-6 mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Welcome back, <?php echo e(Auth::guard('web')->user()->name); ?>!</h1>
        ...
        <div class="p-6">
            <?php if($recentReservations->count() > 0): ?>
                ...
                <div class="mt-6 text-center">
                    <a href="<?php echo e(route('customer.reservations.my')); ?>" class="text-sm font-medium text-blue-600 hover:text-blue-500">
